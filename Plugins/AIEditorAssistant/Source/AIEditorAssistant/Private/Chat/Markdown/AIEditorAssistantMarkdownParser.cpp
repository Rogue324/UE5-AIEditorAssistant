...
FString FAIEditorAssistantMarkdownParser::NormalizeLineEndings(const FString& InText)
{
...
TArray<FAIEditorAssistantMarkdownBlock> FAIEditorAssistantMarkdownParser::ParseBlocks(const FString& MarkdownText)
{
    ...
    auto FlushParagraph = [&]()
    {
        ...
        FAIEditorAssistantMarkdownBlock& Block = Blocks.AddDefaulted_GetRef();
        Block.Type = EAIEditorAssistantMarkdownBlockType::Paragraph;
    ...
    {
        FAIEditorAssistantMarkdownBlock& Block = Blocks.AddDefaulted_GetRef();
        Block.Type = EAIEditorAssistantMarkdownBlockType::CodeBlock;
    ...
    for (int32 Index = 0; Index < Lines.Num(); ++Index)
    {
        ...
        if (IsMarkdownTableLine(TrimmedLine))
        {
            ...
            if (bHasSeparator)
            {
                ...
                FAIEditorAssistantMarkdownBlock& Block = Blocks.AddDefaulted_GetRef();
                Block.Type = EAIEditorAssistantMarkdownBlockType::Table;
