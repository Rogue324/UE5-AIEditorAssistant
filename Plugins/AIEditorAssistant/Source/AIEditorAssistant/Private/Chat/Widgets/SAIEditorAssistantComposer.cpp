...
void SAIEditorAssistantComposer::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
{
...
void SAIEditorAssistantComposer::RebuildAttachmentThumbnails()
{
...
void SAIEditorAssistantComposer::RefreshAttachmentPreviewWidgets()
{
