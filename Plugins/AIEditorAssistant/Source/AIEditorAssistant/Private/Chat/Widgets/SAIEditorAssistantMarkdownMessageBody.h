...
class SAIEditorAssistantMarkdownMessageBody : public SCompoundWidget
{
public:
    SLATE_BEGIN_ARGS(SAIEditorAssistantMarkdownMessageBody) {}
...
private:
    ...
    TSharedRef<class SWidget> BuildBlockWidget(const struct FAIEditorAssistantMarkdownBlock& Block) const;
