...
void SAIEditorAssistantToolConfirmationBar::Construct(const FArguments& InArgs)
{
...
void SAIEditorAssistantToolConfirmationBar::Refresh(const FAIEditorAssistantChatPanelViewState& ViewState)
{
