...
bool FAIEditorAssistantFileChatSessionStore::LoadSessionIndex(FAIEditorAssistantChatSessionIndex& OutIndex) const
{
    OutIndex = FAIEditorAssistantChatSessionIndex();
...
bool FAIEditorAssistantFileChatSessionStore::SaveSessionIndex(const FAIEditorAssistantChatSessionIndex& SessionIndex) const
{
    EnsureChatsDirectoryExists();
...
bool FAIEditorAssistantFileChatSessionStore::LoadSession(const FString& SessionId, FAIEditorAssistantChatSession& OutSession) const
{
    ...
    OutSession = FAIEditorAssistantChatSession();
...
bool FAIEditorAssistantFileChatSessionStore::SaveSession(const FAIEditorAssistantChatSession& Session) const
{
    EnsureChatsDirectoryExists();
...
void FAIEditorAssistantFileChatSessionStore::DeleteSession(const FString& SessionId) const
{
    IFileManager::Get().Delete(*GetSessionPath(SessionId), false, true, true);
}

FString FAIEditorAssistantFileChatSessionStore::GetChatsDirectory() const
{
    return FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("AIEditorAssistant"), TEXT("Chats"));
}

FString FAIEditorAssistantFileChatSessionStore::GetSessionIndexPath() const
{
    return FPaths::Combine(GetChatsDirectory(), TEXT("index.json"));
}

FString FAIEditorAssistantFileChatSessionStore::GetSessionPath(const FString& SessionId) const
{
    return FPaths::Combine(GetChatsDirectory(), FString::Printf(TEXT("%s.json"), *SessionId));
}

void FAIEditorAssistantFileChatSessionStore::EnsureChatsDirectoryExists() const
{
